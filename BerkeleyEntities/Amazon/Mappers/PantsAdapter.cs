...
namespace BerkeleyEntities.Amazon.Mappers
{
    //public class PantsAdapter : ProductData
    //{
    //    public override Product GetProductDto(string condition, string title)
    //    {
    //        //ClothingVariationData variationData = new ClothingVariationData();
    //        //variationData.ParentageSpecified = true;
    //        //variationData.Parentage = ClothingVariationDataParentage.child ;
    ...
    //        //ClothingClassificationData classificationData = new ClothingClassificationData();
