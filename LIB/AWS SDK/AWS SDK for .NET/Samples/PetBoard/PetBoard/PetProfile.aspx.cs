    ...
    public partial class PetProfile : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(this._petIdString))
            {
                ...
                SelectRequest selectRequest = new SelectRequest() { SelectExpression = String.Format("select * from `{0}` where `Pet` = '{1}'", Properties.Settings.Default.PetBoardFriendsDomain, this._petIdString) };
