    ...
    */
    public class MarketplaceWebServiceClient : MarketplaceWebService
    {
        ...
        private IDictionary<String, String> GetHttpHeaderValues(object request)
        {
            ...
            {
                MarketplaceWebServiceRequestHeaderAttribute attribute = (MarketplaceWebServiceRequestHeaderAttribute)
                    Attribute.GetCustomAttribute(mi, typeof(MarketplaceWebServiceRequestHeaderAttribute));
            ...
            {
                MarketplaceWebServiceRequestHeaderAttribute attribute = (MarketplaceWebServiceRequestHeaderAttribute)
                    Attribute.GetCustomAttribute(pi, typeof(MarketplaceWebServiceRequestHeaderAttribute));
        ...
        private IDictionary<String, String> ConvertManageReportSchedule(ManageReportScheduleRequest request)
        {
            ...
            {
                parameters.Add("ScheduledDate", GetFormattedTimestamp(request.ScheduledDate));
            }
