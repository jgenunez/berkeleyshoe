    ...
    public class OrderItem
    {
        ...
        public override string ToString()
        {
            ...
            if (IsSetConditionNote()) {
                ...
                result.AppendLine(EscapeXML(this.ConditionNote));
            }
            if (IsSetConditionId()) {
                result.Append("ConditionId: ");
                result.AppendLine(EscapeXML(this.ConditionId));
            }
            if (IsSetConditionSubtypeId()) {
                result.Append("ConditionSubtypeId: ");
                result.AppendLine(EscapeXML(this.ConditionSubtypeId));
            }
            if (IsSetScheduledDeliveryStartDate()) {
                result.Append("ScheduledDeliveryStartDate: ");
                result.AppendLine(EscapeXML(this.ScheduledDeliveryStartDate));
            }
            if (IsSetScheduledDeliveryEndDate()) {
                result.Append("ScheduledDeliveryEndDate: ");
                result.AppendLine(EscapeXML(this.ScheduledDeliveryEndDate));
            }
